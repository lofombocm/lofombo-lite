...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('loyaltyaccounts', function (Blueprint $table) {
            ...
            $table->double('purchase_amount_balance')->nullable(false)->default(0);
            $table->double('gift_amount_balance')->nullable(false)->default(0);
            $table->double('birthdate_amount_balance')->nullable(false)->default(0);
            $table->text('point_balance')->nullable(false)->default('0'); // point accumule obtenu de la conversion montant point suivant la conversion defini
            $table->text('current_point')->nullable()->default('0'); // point courant avant la prochaine modification
        ...
        Schema::create('configs', function (Blueprint $table) {
            ...
            $table->string('enterprise_website')->nullable(false)->default(url('/'.GuestController::getApplicationLocal()));
        ...
        Schema::create('loyaltytransactions', function (Blueprint $table) {
            ...
            $table->double('purchase_amount')->nullable(false)->default(0);
            $table->double('gift_amount')->nullable(false)->default(0);
            $table->double('birthdate_amount')->nullable(false)->default(0);
            $table->bigInteger('point')->nullable(false)->default(0);
            $table->double('old_amount')->nullable(false)->default(0);
            $table->text('old_point')->nullable(false)->default('0');
