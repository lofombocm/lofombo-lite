...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __("Merci d'accepter notre invitation") }}</div>

                    <div class="card-body">
                        <form method="POST"
                              action="{{ route('client.friend-invitations.accept.index.post', [$clientid, $invitationid]) }}"
                            ...
                            <input type="hidden" name="inviter_id" id="inviter_id" value="{{$inviter->id}}">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                           name="name" value="{{ $invitation->name == null ? old('name') : $invitation->name }}" required autocomplete="name" autofocus>
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="telephone"
                                           type="tel" class="form-control @error('telephone') is-invalid @enderror"
                                           name="telephone" value="{{ $invitation->telephone == null ? old('telephone') : $invitation->telephone }}" required autocomplete="telephone">
                            ...
                            {{--<div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           ...
                                           name="email" value="{{ $invitation->email }}" autocomplete="email">
