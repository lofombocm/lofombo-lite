...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Inviter un ami') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('client.friend-invitations.index.post', $clientid) }}" onsubmit="return true;">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <label for="name" class="col-md-4 col-form-label text-md-end">{{ __("Nom de l'ami") }}
                                    {{--<b class="" style="color: red;">*</b>--}}
                                </label>
                            ...
                            <div class="row mb-3">
                                <label for="quarter" class="col-md-4 col-form-label text-md-end">{{ 'Lieu de résidence' }}</label>
