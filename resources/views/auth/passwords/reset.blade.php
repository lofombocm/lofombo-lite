        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" >
                    <h5>{{ __('Réinitialisation du mot de passe') }}</h5>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('password.reset.post',['locale' => GuestController::getApplicationLocal()]) }}">
                        ...
                        <div class="row mb-3">
                            <label for="current-pwd" class="col-md-4 col-form-label text-md-end">
