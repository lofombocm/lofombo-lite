                            ...
                            <div class="col-md-6">
                                ...
                                @if($user->is_admin)
                                    <input
                                        id="isadmin"
                                        type="checkbox"
                                        class="@error('isadmin') is-invalid @enderror"
                                        name="isadmin" value="on"  autocomplete="isadmin"
                                        style="height: 20px; width: 20px; margin-top: 10px;" onchange="setIsAdmin(this, 'is_admin');" checked>
                                    <input name="is_admin" id="is_admin" value="on" type="hidden">
                                @else
                                    <input
                                        id="isadmin"
                                        type="checkbox"
                                        class="@error('isadmin') is-invalid @enderror"
                                        name="isadmin" value="off"  autocomplete="isadmin"
